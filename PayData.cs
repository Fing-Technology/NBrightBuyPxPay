...
namespace Nevoweb.DNN.NBrightStore
{
    ...
    public class PxPay
    {
        private static NBrightInfo _settings = ProviderUtils.GetProviderSettings("NBrightPxPaypayment");

        private string _LiveServiceUrl = _settings.GetXmlProperty("genxml/textbox/liveurl");
        ...
        {
            var webserviceurl = _LiveServiceUrl;
